  ...
  methods: {
    ...
    handleAddCompanyContactOK(){
      ...
      if(this.newTopicCompany===0){//没有选择company的提示
        this.$Notice.open({title: this.$t('ChatFloating.NotificationTitle'),desc: this.$t('KloudSyncDocLeftPart.PleaseSelectCompany'), top: 24,duration: 4, left:true });
        return;
      }
    ...
    handleAddTopicOK() {
      if(this.addSyncRoomCurrentTeamID<=0){
        this.$Notice.open({title: this.$t('ChatFloating.NotificationTitle'),desc: this.$t('KloudSyncDocLeftPart.TeamCannotBeEmpty'), top: 24,duration: 4, left:true });
        return;
      }

      if(this.addSyncRoomCurrentTeamSpaceID<=0){
        this.$Notice.open({title: this.$t('ChatFloating.NotificationTitle'),desc: this.$t('KloudSyncDocLeftPart.SpaceCannotBeEmpty'), top: 24,duration: 4, left:true });
        return;
      }

      if(this.newTopicName==""){
        this.$Notice.open({title: this.$t('ChatFloating.NotificationTitle'),desc: this.$t('KloudSyncDocLeftPart.SyncRoomNameCannotBeEmpty'), top: 24,duration: 4, left:true });
        return;
      }

    ...
    handleCompanyOrIndicidualOK() {
      ...
      if(this.isCompany){
        ...
        if(this.companyContacts.length === 0){
          this.$Notice.open({title: this.$t('ChatFloating.NotificationTitle'),desc: 'Please select company contacts', top: 24,duration: 4, left:true });
          return;
        }
        ...
        if(this.individualContact.length == 0) {
          this.$Notice.open({title: this.$t('ChatFloating.NotificationTitle'),desc: 'Please select contacts', top: 24,duration: 4, left:true });
          return;
        }

...
export default {
  ...
  methods: {
    ...
    saveEditTag(item,e){
      ...
      var val=$(target).val();
      if(val==""){
        this.$Notice.open({title: this.$t('ChatFloating.NotificationTitle'),desc: this.$t('ManageTags.TagNameCannotBeEmpty'), top: 24,duration: 4, left:true });

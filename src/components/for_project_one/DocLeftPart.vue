<template>
<div class="forProject-doc-left-part">
  <div class="team">
          ...
          <Poptip ref="poptipTeam" placement="bottom-start">
            ...
            <div slot="title" style="min-height: 32px;display:flex;align-items:center">
              <div style="flex:1 1 120px;min-width:120px">
                <b style="line-height:32px">Projects</b>
              </div>
              <Checkbox v-if="isCompanyOwnerOrAdmin" style="margin-right:10px;" v-model="showAllTeam" @on-change="handTeamList">Show all projects</Checkbox>
  ...
  <div class="space">
    <div class="space-title">
      <span style="flex:1 1 200px;color: #bdc5b8;padding-bottom: 15px;">Module of current project</span>
    ...
    <div class="space-content">
      <div class="space-item" style="color:#2d8cf0;" @click="handleSelectSpace(null)" :class="{'space-current': currentSpace.id <= 0}">
        ...
        <span style="margin-left: 10px;">All modules</span>
      </div>

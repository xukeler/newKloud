<template>
  <div class="forProject-topic-files">
    ...
    <Modal v-model="modalShareFile" class="forProject-topic-file-share">
      <div slot="close" style="display:none"></div>
      <div slot="header" style="display:none"></div>
      <div slot="footer" style="display:none"></div>
      <div class="forProject-topic-file-share-body">
...
.forProject-topic-file-share {
  .forProject-topic-file-share-body {
    display: flex;
    flex-direction: row;

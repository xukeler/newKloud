<template>
  <div class="forProject-kloudsync-help">
    ...
    <Modal v-model="modalViewFile" class="forProject-kloudsync-file-view" width="90%" :mask-closable="false" :title="modalViewFileTitle">
      <div slot="footer" style="display:none"></div>
      <div class="forProject-kloudsync-file-view-body">
...
.forProject-kloudsync-file-view
{
  .forProject-kloudsync-file-view-body
  {
    width: 100%;
    height: 100%;
  }
  ...
  methods: {
    manageSysSpace(){
      ...
      auth.MemorizeOrganization(10001,schoolId,-1,"Help center","",null,null).then((res)=>{
        ...
        self.reloadHeader();
        self.$nextTick(()=>{
          self.$router.push({name:'projectone-documents'});
        })
      });
    },
    getSystemMemberList(){

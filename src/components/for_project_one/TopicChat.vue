<template>
<div class="forProject-sync-room-chat" id="forProject-sync-room-chat" :style="{'height':inSyncRoomMeeting?'calc(100vh - 50px)':'calc(100vh - 275px);'}">

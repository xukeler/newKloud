...
if (localStorage.getItem("Language") && localStorage.getItem("Language") == "cn") {
    ...
    labelWeek = "周";
    labelMonth = "月";
    labelMettingNow = "开始会议";
    labelScheduleMeeting = "安排会议";
    labelNewLesson = "新建课堂";
} 
else {
    labelAddLesson = "New";
    ...
    labelWeek = "Week";
    labelMonth = "Month";
    labelMettingNow = "Metting Now";
    labelScheduleMeeting = "Schedule Meeting";
    labelNewLesson ="New Lesson";
}
        ...
        TOOLBARTEMPLATE = kendo.template('<div class="k-floatwrap k-header k-scheduler-toolbar">' +
          ...
          '#}#' +
            ...
            '<ul class="k-reset k-header" style="float: left; margin-left: 1em;">' +
                '<li>' +
            '<span class="k-textbox k-space-right" style="width: 200px; border-width: 0; background: white;" > <input type="text" placeholder="' + labelSearch+'" id="scheduler-search-input"/> <a href="\\#" class="k-icon k-i-search" id="scheduler-search-icon"></a> </span>' +
                '</li>' +
            '</ul>' +
            ...
            '<li class="k-state-default k-state-selected" id="scheduler-add-lesson"><a role="button" href="\\#" class="k-link" style="color:white;"><i class="ivu-icon ivu-icon-plus-round" style="margin-right: 0.5em;"></i> <span>' + labelAddLesson+'</span></a></li>' +
            // [Change -- add new menu list]
            '<div id="scheduler-MenuList" class="scheduler-Menu-List">'+
            '<ul><li id="schedule-do-metting-now">' + labelMettingNow + '</li><li id="schedule-metting">' + labelScheduleMeeting + '</li><li id="schedule-new-lesson">' + labelNewLesson + '</li></ul>'+
            '</div>'+
            '</ul>' +

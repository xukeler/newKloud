...
(function($, undefined) {
    var kendo = window.kendo,
        ...
        templates = {
            ...
            item: template(  //[Change -- add data attributes]
                "<li role='menuitem' #=aria(item)#class='#= wrapperCssClass(group, item) #'#=dataAttributes(item)#>" +
                    "#= itemWrapper(data) #" +
                    "# if (item.items) { #" +
        ...
        rendering = {
            ...
            dataAttributes: function (item) {
                var attr = "";

                if (item.path)
                    attr += "data-path='" + item.path + "' ";
                if (item.courseId)
                    attr += "data-course='" + item.courseId + "' ";
